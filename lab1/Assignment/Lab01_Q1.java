...
{      
   public static void main( String args[]  
   {
      ...
      fnial double GRADE_PERCENT_PER_LAB = LABS_GRADE_PERCENT / LABS_COUNT;
      
      // Variables
      Sting courseAndSemester;     
      ...
      SSystem.out.println( "Labs contribute to " + LABS_GRADE_PERCENT + "% of your total grade." );
