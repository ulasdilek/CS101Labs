...
public class FoodBasket_revisionTUE {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n\t\t\t***\tWelcome to FoodBasket!\t***\t\t\t\n*\t*\t*\tThank you for helping us exploit more workers\t*\t*\t*");
    ...
    public static void surprise(Order o1, Order o2) {
        if (o1.getUser().equals(o2.getUser())) {
                System.out.println("This is a lucky day for " + o1.getUser().getName() + "! A discount of 20% will be applied to the second order.\nApplying surprise discount of 20%...");
                o2.setDiscountRate(0.2);
        }
        else {
                System.out.println("OH NO! The orders " + o1.getID() + " and " + o2.getID() + " are for different people!");
        }
    }
