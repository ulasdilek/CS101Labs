...
public class Lab02_Q3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Remove leading and trailing blank characters:" + input.trim());
        ...
        System.out.println("Substring from 3rd character(inclusive) to 8th character(exclusive):" + input.substring(3, 8));
