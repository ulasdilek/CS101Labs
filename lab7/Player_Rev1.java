...
public class Player_Rev1 {
    ...
    //instance methods
    public void register(String name, String position, Team team, int rosterNumber) {
        setName(name);
    ...
    public boolean isBeforeThan(Player_Rev1 otherPlayer) {
        return this.name.toUpperCase().compareTo(otherPlayer.name.toUpperCase()) < 0;
    }

    public boolean isMoreEfficient(Player_Rev1 otherPlayer) {
