...
public class MusicApp_RevTue {
    ...
    {
        ArrayList<Playlist_RevTue> playlists = new ArrayList<>();
        Playlist_RevTue playlist = null;
        ...
        while (appOn) {
            ...
            if (response == 1) {
            ...
            else if (playlists.isEmpty() && response != 9) {
                ...
                for (Playlist_RevTue pl: playlists) {
    ...
    private static void addSongs (Playlist_RevTue playlist, Scanner scanner) {
